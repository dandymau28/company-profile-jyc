    ...
    <div class="latihan-rutin mt-5 mb-5">
        ...
        <div class="container">
            ...
            <div class="row latihan-text">
                <p class="col-md-6 pt-4" data-aos="fade-up" data-aos-duration="1500"> <strong><em>“Practice makes perfect”</em></strong> , pastinya kata ini tidaklah asing di telinga banyak orang pada kehidupan sehari-hari khususnya untuk kita yang berkecimpung di dunia paduan suara. <b>Jakarta Youth Choir</b>, sama seperti paduan suara pada umumnya, bisa berprestasi dan menunjukkan kualitas dirinya saat ini tentunya tidaklah instan. <b>Jakarta Youth Choir</b> dapat cemerlang berkat proses suka duka latihan bersama. <b>Jakarta Youth Choir</b> biasa melakukan latihan rutin minimal satu pekan sekali, saat ini pada setiap hari Rabu berdasarkan kesepakatan anggota yang bertempat di <b>Gedung Dinas Pemuda dan Olahraga Provinsi DKI Jakarta</b>.</p>
        ...
        <div class="demo-gallery">
            <section id="galeri">
                ...
                <div id="lightgallery" class="my-3 row">
                    ...
                    <a class="col-12 col-sm-6 col-md-4 pb-2 pb-md-4" href="" data-responsive="{{Storage::url($foto->alamat_foto)}}" data-src="{{Storage::url($foto->alamat_foto)}}" data-sub-html="<h4>{{ $foto->nama_kategori }}</h4><p>{{ $foto->deskripsi }}</p>">

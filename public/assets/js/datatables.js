 ...
 *   https://datatables.net/download/#bs4/dt-1.10.20/b-1.6.1/b-flash-1.6.1/r-2.2.3/sp-1.0.1/sl-1.3.1
 *
 * Included libraries:
 *   DataTables 1.10.20, Buttons 1.6.1, Flash export 1.6.1, Responsive 2.2.3, SearchPanes 1.0.1, Select 1.3.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.20/b-1.6.1/b-flash-1.6.1/r-2.2.3/sp-1.0.1/sl-1.3.1",
